...
export const baseLevels: Level[] = [
  ...
  },
  {
    ...
    percentage: 0,
    competencias: [
      { id: 33, title: 'Desenvolvimento full-stack', category: 'CRIA�?�fO DE CONTE�sDO', categoryColor: '#FF9800', icon: Code, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 34, title: 'Integração de sistemas', category: 'CRIA�?�fO DE CONTE�sDO', categoryColor: '#FF9800', icon: Files, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 35, title: 'Marketing digital', category: 'COMUNICA�?�fO E COLABORA�?�fO', categoryColor: '#00BCD4', icon: Share2, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 36, title: 'Comunicação estratégica', category: 'COMUNICA�?�fO E COLABORA�?�fO', categoryColor: '#00BCD4', icon: MessageCircle, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 37, title: 'Big data research', category: 'INFORMA�?�.ES E DADOS', categoryColor: '#FFD700', icon: Search, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 38, title: 'Personal branding', category: 'COMUNICA�?�fO E COLABORA�?�fO', categoryColor: '#00BCD4', icon: Fingerprint, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 39, title: 'Data science', category: 'INFORMA�?�.ES E DADOS', categoryColor: '#FFD700', icon: BarChart3, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 40, title: 'Gestão de equipes remotas', category: 'COMUNICA�?�fO E COLABORA�?�fO', categoryColor: '#00BCD4', icon: Users, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 41, title: 'Inteligência de dados', category: 'INFORMA�?�.ES E DADOS', categoryColor: '#FFD700', icon: BarChart3, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 42, title: 'Produção transmídia', category: 'CRIA�?�fO DE CONTE�sDO', categoryColor: '#FF9800', icon: ImageIcon, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 43, title: 'Storytelling digital', category: 'CRIA�?�fO DE CONTE�sDO', categoryColor: '#FF9800', icon: FileEdit, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 44, title: 'Cybersecurity', category: 'PROTE�?�fO E SEGURAN�?A', categoryColor: '#4CAF50', icon: Shield, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 45, title: 'LGPD e compliance', category: 'PROTE�?�fO E SEGURAN�?A', categoryColor: '#4CAF50', icon: Lock, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 46, title: 'Sustentabilidade digital', category: 'PROTE�?�fO E SEGURAN�?A', categoryColor: '#4CAF50', icon: Heart, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 47, title: 'Inovação tecnológica', category: 'RESOLU�?�fO DE PROBLEMAS', categoryColor: '#E91E63', icon: Wrench, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
      { id: 48, title: 'Transformação digital', category: 'RESOLU�?�fO DE PROBLEMAS', categoryColor: '#E91E63', icon: TrendingUp, completed: false, starsEarned: 0, totalStars: 3, status: 'not-started' },
    ],
  },
];
