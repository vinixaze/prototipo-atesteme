...
interface CompetencyTestCongratsPageProps {
...
export default function CompetencyTestCongratsPage({
  navigateTo,
  testData,
}: CompetencyTestCongratsPageProps) {
  ...
  const handleContinue = () => {
    // Navegar para a tela de resultado detalhado
