...
interface TransversalityHistorySectionProps {
  searchHistory: HistoryItem[];
  onViewHistory: (filters: HistoryItem["filters"]) => void;
}

export default function TransversalityHistorySection({
  searchHistory,
  onViewHistory,
}: TransversalityHistorySectionProps) {
  return (
        ...
        {searchHistory.map((item, idx) => (
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              {/* ƒo. BotÇœo "Ver" (padrÇœo roxo com borda, igual sua 2¶¦ imagem) */}
              <motion.button
