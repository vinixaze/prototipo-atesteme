...
import type { BnccSingleSelectProps } from "../types";

export default function BnccSingleSelect({
  label,
  placeholder = "Digite um cÇüdigoƒ?Ý",
  options,
  value,
  onChange,
  ...
  const pick = (code: string) => {
    onChange(code);      // ƒo. sÇü 1 (substitui)
    setOpen(false);
  };
      ...
      <div className="relative">
        ...
        {open && (
          <div className="absolute z-20 mt-2 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden">
            {/* ƒo. Scroll sÇü aqui (nÇœo mexe no scroll do modal) */}
            <div
