import { AlertCircle, Camera, Check, CheckCircle2, Clock, Image as ImageIcon, Mail, Upload, User } from "lucide-react";
...
export default function ProfilePhotoCard({
  ...
  return (
    <div
      className="bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-10 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 mb-8 animate-slideUp"
      style={{ animationDelay: "100ms" }}
    >
      <div className="flex flex-col md:flex-row items-center gap-8">
        {/* Avatar */}
        <div className="relative group cursor-pointer" onClick={onOpenWebcam}>
