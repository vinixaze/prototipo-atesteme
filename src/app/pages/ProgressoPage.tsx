  ...
  const baseLevels: Level[] = [
    {
      ...
      percentage: 43,
      competencias: [
        { id: 1, title: 'Programar sistemas', category: 'CRIAÇÃO DE CONTEÚDO', categoryColor: '#FF9800', icon: Code, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '15/12/2024', timeSpent: '08min 32s', digcoinsEarned: 9 },
        { id: 2, title: 'Adaptar arquivos', category: 'CRIAÇÃO DE CONTEÚDO', categoryColor: '#FF9800', icon: Files, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '16/12/2024', timeSpent: '07min 18s', digcoinsEarned: 9 },
        { id: 3, title: 'Compartilhar e publicar', category: 'COMUNICAÇÃO E COLABORAÇÃO', categoryColor: '#00BCD4', icon: Share2, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '16/12/2024', timeSpent: '06min 45s', digcoinsEarned: 9 },
        { id: 4, title: 'Interagir', category: 'COMUNICAÇÃO E COLABORAÇÃO', categoryColor: '#00BCD4', icon: MessageCircle, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '17/12/2024', timeSpent: '05min 52s', digcoinsEarned: 9 },
        { id: 5, title: 'Realizar pesquisa e monitoramento', category: 'INFORMAÇÕES E DADOS', categoryColor: '#FFD700', icon: Search, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '17/12/2024', timeSpent: '09min 15s', digcoinsEarned: 9 },
        { id: 6, title: 'Gerir a identidade digital', category: 'COMUNICAÇÃO E COLABORAÇÃO', categoryColor: '#00BCD4', icon: Fingerprint, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '18/12/2024', timeSpent: '07min 03s', digcoinsEarned: 9 },
        { id: 7, title: 'Gerenciar dados', category: 'INFORMAÇÕES E DADOS', categoryColor: '#FFD700', icon: FolderOpen, completed: true, starsEarned: 3, totalStars: 3, status: 'completed', completedDate: '18/12/2024', timeSpent: '08min 27s', digcoinsEarned: 9 },
