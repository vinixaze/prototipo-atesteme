...
import { AvatarOption } from '../../types/profile';
...
export default function AvatarModal({ isOpen, onClose, onSelect, avatars, selectedAvatar }: AvatarModalProps) {
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {avatars.map((avatar) => (
            <button
              ...
              className={`relative p-3 rounded-xl border-2 transition-all duration-300 group ${!avatar.unlocked
