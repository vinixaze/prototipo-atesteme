import { Check, Image as ImageIcon, Lock, RefreshCcw, Sparkles, X } from 'lucide-react';
import type { BannerLevel } from '../../data/profileData';

interface ProfileBannersModalProps {
  isOpen: boolean;
  banners: BannerLevel[];
...
export default function ProfileBannersModal({
  isOpen,
  banners,
  selectedBanner,
  onSelectBanner,
