...
import type { CollectibleAvatar } from '../../data/profileData';

interface ProfileAvatarsModalProps {
  isOpen: boolean;
  avatars: CollectibleAvatar[];
...
export default function ProfileAvatarsModal({
  isOpen,
  avatars,
  selectedAvatar,
  onSelectAvatar,
