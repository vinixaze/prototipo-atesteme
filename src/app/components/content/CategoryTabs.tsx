        ...
        {categories.map((category) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`flex-1 min-w-[120px] md:min-w-[160px] flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-3 py-3 rounded-xl transition-all font-semibold text-sm ${isActive
