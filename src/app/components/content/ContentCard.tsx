...
import { ExternalLink, Play, Globe, FileText } from 'lucide-react';
...
export default function ContentCard({ content, index, categoryColor }: ContentCardProps) {
  const formatIcon = content.format === 'Vídeo' ? Play :
    content.format === 'Site' ? Globe : FileText;
