...
import type { ContentItem, ContentCategory } from '../../data/contentData';
...
export default function ContentCard({ content, category, index }: ContentCardProps) {
  const formatIcon = content.format === 'Vídeo' ? Play : content.format === 'Site' ? Globe : FileText;
