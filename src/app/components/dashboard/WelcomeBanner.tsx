...
export default function WelcomeBanner({ isVisible, onClose, colors, greeting = 'usuário(a)' }: WelcomeBannerProps) {
      ...
      <div className="relative z-10 flex items-center gap-4">
        ...
        <div className="text-left">
          ...
          <p className="text-white/90 text-xs md:text-base mt-1">
            Pronto para iniciar sua jornada de aprendizagens digitais?
          </p>
        </div>
      </div>
    </motion.div>
